...
@AutoConfigureStubRunner(stubsMode = StubRunnerProperties.StubsMode.LOCAL, ids = "com.example:08-01-producer")
public class BeerControllerTest {

	@StubRunnerPort("08-01-producer") int producerPort;
	...
	@Test public void should_give_me_a_beer_when_im_old_enough() {
		...
		BDDAssertions.then(response.name).isEqualTo("marcin");
		BDDAssertions.then(response.path).isEqualTo("check");
	}
